  ...
  
{
  ...
  matplot((c(1:T)),t(y),xlab="time(t)", ylab="change in population of species at time t", 
          main="Population Fluctuations of S Species vs. Time",lty=1, col=rainbow(S), type="l") #time series plot
