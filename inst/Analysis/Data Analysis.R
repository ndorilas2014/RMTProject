  ...
  
{
  ...
  for (j in 2:T)
  {
    for (i in 1:S)
    {
      ...
      y<-TS(A2, dt, y, xi=noise, i, j)
    }
  }
  
  
  matplot((c(1:T)),t(y),xlab="time(t)", ylab="change in abundance of species at time t", 
          main="Population Abundances of S Species vs. Time",lty=1, col=rainbow(S), type="l") #time series plot
